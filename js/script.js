    ...
    return `
        ...
        ${contact.name}
            <div class="btn-group dropleft" style = "float: right" >
                <button type="button" class="btn note btn-contact" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class = "btn-icon" src="./img/icons/more.svg" alt="ещё">
                </button>
            <div class="dropdown-menu notepad note ">
                <button class="dropdown-item" data-toggle="modal" data-target="#modal-change-mobile" type="button">
                    <img src="./img/icons/pen.svg" style="height: 24px; width: 24px; padding-right: 5px;" alt="">
                    Редактировать
                </button>
                <button class="dropdown-item btn-delete-contact" data-toggle="modal" data-target="#modal-delete-cont"
                    type="button">
                    <img src="./img/icons/trash.svg" style="height: 24px; width: 24px; padding-right: 5px;" alt="">
                    Удалить
                </button>
            </div>
        </div>
